...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/thekingcooingsolutions@gmail.com", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <section id="contact" className="py-20 md:py-24 px-4 md:px-6 bg-[#F1F5F9] scroll-mt-20">
      <div className="max-w-[1232px] mx-auto px-2 md:px-0">
        <div className="bg-white rounded-3xl md:rounded-[48px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-0">
            {/* Left Side - Blue Background with Contact Info */}
            <div className="bg-brand-blue p-6 md:p-12 lg:p-20 text-white order-2 lg:order-1">
              <h2 className="text-2xl md:text-4xl font-extrabold mb-4 md:mb-6 leading-tight">
                Ready to get started?
              </h2>
              <p className="text-base md:text-xl text-[#E0F2FE] mb-8 md:mb-12 leading-6 md:leading-7">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start gap-3 md:gap-6">
                  <div className="w-10 md:w-12 h-10 md:h-12 bg-white/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <div className="text-xs md:text-sm text-[#BAE6FD] mb-1 font-semibold">Call Us</div>
                    <div className="text-sm md:text-xl font-bold break-words">044-47800436</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-6">
                  ...
                  <div>
                    <div className="text-xs md:text-sm text-[#BAE6FD] mb-1 font-semibold">Email Us</div>
                    <div className="text-xs md:text-xl font-bold break-words">thekingcoolingsolutions@gmail.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-6">
                  ...
                  <div>
                    <div className="text-xs md:text-sm text-[#BAE6FD] mb-1 font-semibold">Visit Us</div>
                    <div className="text-sm md:text-xl font-bold">Arcot Road, Chennai, TN</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Side - Form */}
            <div className="p-6 md:p-12 lg:p-20 order-1 lg:order-2">
              <form method="POST" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 md:px-6 py-3 md:py-4 text-sm md:text-base border border-brand-borderGray rounded-xl md:rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand-blue"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-brand-mutedText mb-2">
                ...
                <div>
                  ...
                  <select
                    name="serviceType"
                    required
                    className="w-full px-4 md:px-6 py-3 md:py-4 text-sm md:text-base border border-brand-borderGray rounded-xl md:rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand-blue appearance-none bg-white"
                    style={{
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="w-full px-4 md:px-6 py-3 md:py-4 text-sm md:text-base border border-brand-borderGray rounded-xl md:rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand-blue resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-brand-blue text-white font-extrabold text-sm md:text-base px-6 md:px-8 py-3 md:py-5 rounded-xl md:rounded-2xl shadow-[0_20px_25px_-5px_rgba(30,64,175,0.20),0_8px_10px_-6px_rgba(30,64,175,0.20)] hover:bg-brand-blue/90 transition-colors flex items-center justify-center gap-2"
                >
